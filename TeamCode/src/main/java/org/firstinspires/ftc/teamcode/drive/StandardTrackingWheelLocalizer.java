...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 12.65; // i n; distance between the left and right wheels
    public static double FORWARD_OFFSET = -2; // in; offset of the lateral wheel

    public static double X_MULTIPLIER = 1.00053237;
    public static double Y_MULTIPLIER = 1.006522554;
